...
<head>
  ...
  <style>
    ...
    body {
      ...
      --sidebar-border: #333;
      --link-color: white;
      --link-hover-color: #ff66cc;
      --input-btn-bg: #222;
      --input-btn-border: #555;
      --output-bg: #111;
      --output-border: #333;
      --code-bg: #111; /* Assuming code-area background */
      --code-border: #333; /* Assuming code-area border */
      --button-hover-bg: #333;
      ...
      transition: background-color 0.5s ease, color 0.5s ease, text-shadow 0.5s ease; /* Smooth transition for themes */
      margin: 0;
      display: flex;
    }
    ...
    body.minecraft-theme {
      ...
      font-family: monospace; /* Keeping default monospace, as there's no pixelated Minecraft font easily available through Google Fonts without adding more complexity */
    }
